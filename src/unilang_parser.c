...
void *parse_literal_c4(lexer_t *l, int *worked);
...
void *parse_type_c2(lexer_t *l, int *worked);

void *parse_type_c3(lexer_t *l, int *worked);
...
// RULE tlist
// RULE inst_template
void *parse_inst_template_c0(lexer_t *l, int *worked);
...
void *parse_class_constructor_c0(lexer_t *l, int *worked);

void *parse_class_constructor_c1(lexer_t *l, int *worked);
...
void *parse_class_body_item_c2(lexer_t *l, int *worked);
...
void *parse_interface_c1(lexer_t *l, int *worked);
...
void *parse_literal(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  rule_cpy = *l;
  rule_res = parse_literal_c4(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_type(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  rule_cpy = *l;
  rule_res = parse_type_c2(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
  ...
  rule_cpy = *l;
  rule_res = parse_type_c3(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_tlist(lexer_t *l, int *worked) {
  ...
  while (1) {
    lexer_t old = *l;
    void *elem = parse_type(l, &rule_worked);
    if (!rule_worked) {
      break;
    }
    if (count + 1 >= cap) {
...
void *parse_inst_template(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  void *rule_res = NULL;
  lexer_t rule_cpy = *l;
  rule_res = parse_inst_template_c0(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_class_constructor(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  void *rule_res = NULL;
  lexer_t rule_cpy = *l;
  rule_res = parse_class_constructor_c0(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
  ...
  rule_cpy = *l;
  rule_res = parse_class_constructor_c1(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_class_body_item(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  rule_cpy = *l;
  rule_res = parse_class_body_item_c2(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_interface(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  rule_cpy = *l;
  rule_res = parse_interface_c1(&rule_cpy, &rule_worked);
  if (rule_worked) {
    *worked = 1;
    *l = rule_cpy;
    return rule_res;
...
void *parse_literal_c4(lexer_t *l, int *worked) {
  *worked = 0;
  void *elem_0 = parse_boollit(l, worked);
  if (!*worked) {
    return NULL;
  }
  return elem_0;
...
void *parse_type_c0(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  void *elem_1 = parse_inst_template(l, worked);
  if (!*worked) {
    return NULL;
  }
  void *elem_2 = parse_starlist(l, worked);
  if (!*worked) {
    return NULL;
  }
  ...
  free_ast(iden);
  return new_type(tok, count, true, templ);
}
void *parse_type_c1(lexer_t *l, int *worked) {
  *worked = 0;
  void *elem_0 = parse_identifier(l, worked);
  ...
  token_t tok = iden->as.identifier.tok;
  free_ast(iden);
  return new_type(tok, count, false, NULL);
}
void *parse_type_c2(lexer_t *l, int *worked) {
  *worked = 0;
  void *elem_0 = parse_identifier(l, worked);
  ...
  token_t tok = iden->as.identifier.tok;
  free_ast(iden);
  return new_type(tok, 0, true, templ);
}
void *parse_type_c3(lexer_t *l, int *worked) {
  *worked = 0;
  void *elem_0 = parse_identifier(l, worked);
  ...
  token_t tok = iden->as.identifier.tok;
  free_ast(iden);
  return new_type(tok, 0, false, NULL);
}
void *parse_unary_c0(lexer_t *l, int *worked) {
  *worked = 0;
...
void *parse_tempelem_c0(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  free(parse_token_lexeme(l, worked, SV("impl")));
  if (!*worked) {
    return NULL;
  }
  ...
  return new_tempelem(elem_0, elem_2);
}
void *parse_template_c0(lexer_t *l, int *worked) {
  *worked = 0;
  free(parse_token_lexeme(l, worked, SV("<")));
...
void *parse_inst_template_c0(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  void *elem_1 = parse_tlist(l, worked);
  if (!*worked) {
    return NULL;
  }
  free(parse_token_lexeme(l, worked, SV(">")));
  ...
  // template but the args are types and not tempelems
  return new_template(elem_1);
}
void *parse_fundef_letless_c0(lexer_t *l, int *worked) {
  *worked = 0;
...
void *parse_class_body_item_c1(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  void *elem_3 = parse_class_constructor(l, worked);
  if (!*worked) {
    return NULL;
  }
...
void *parse_interface_c1(lexer_t *l, int *worked) {
  *worked = 0;
  ...
  free_ast(name_ptr);
  free_ast(type_ptr);
  ast_t **protos = malloc(sizeof(void *));
  protos[0] = NULL;
  size_t protos_count = 0;
  return new_interface(type, name, protos, protos_count);
}
