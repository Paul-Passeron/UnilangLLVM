...
main:
	...
	leaq	-64(%rbp), %r14
	movq	%r14, %rdi
	callq	vectorZ1_0@PLT
	movl	$0, -44(%rbp)
	.p2align	4, 0x90
.LBB0_1:
	movl	-44(%rbp), %r15d
	movq	%r14, %rdi
	callq	vectorZ1_len@PLT
	cmpl	%eax, %r15d
	jge	.LBB0_3
	movl	-44(%rbp), %esi
	movq	%r14, %rdi
	callq	vectorZ1_at@PLT
	movq	%rsp, %rsi
	leaq	-16(%rsi), %rbx
	movq	%rbx, %rsp
	movl	%ecx, -4(%rsi)
...
.Lfunc_end4:
	...
	.globl	vectorZ0_len
	.p2align	4, 0x90
	.type	vectorZ0_len,@function
vectorZ0_len:
	.cfi_startproc
	movl	8(%rdi), %eax
	retq
.Lfunc_end5:
	.size	vectorZ0_len, .Lfunc_end5-vectorZ0_len
	.cfi_endproc

	.globl	vectorZ1_0
	.p2align	4, 0x90
	.type	vectorZ1_0,@function
vectorZ1_0:
	.cfi_startproc
	pushq	%rbx
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end6:
	.size	vectorZ1_0, .Lfunc_end6-vectorZ1_0
	.cfi_endproc

	.globl	vectorZ1_at
	.p2align	4, 0x90
	.type	vectorZ1_at,@function
vectorZ1_at:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.LBB7_2:
	...
	callq	string_destroy@PLT
.Lfunc_end7:
	.size	vectorZ1_at, .Lfunc_end7-vectorZ1_at
	.cfi_endproc

	.globl	vectorZ1_append
	.p2align	4, 0x90
	.type	vectorZ1_append,@function
vectorZ1_append:
	.cfi_startproc
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.LBB8_5:
	...
	retq
.Lfunc_end8:
	.size	vectorZ1_append, .Lfunc_end8-vectorZ1_append
	.cfi_endproc

	.globl	vectorZ1_destroy
	.p2align	4, 0x90
	.type	vectorZ1_destroy,@function
vectorZ1_destroy:
	.cfi_startproc
	pushq	%rbx
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end9:
	.size	vectorZ1_destroy, .Lfunc_end9-vectorZ1_destroy
	.cfi_endproc

	.globl	vectorZ1_len
	.p2align	4, 0x90
	.type	vectorZ1_len,@function
vectorZ1_len:
	.cfi_startproc
	movl	8(%rdi), %eax
	retq
.Lfunc_end10:
	.size	vectorZ1_len, .Lfunc_end10-vectorZ1_len
	.cfi_endproc
